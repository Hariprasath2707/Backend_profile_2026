...
export default function About() {
  ...
  return (
    <section id="about" className="px-6 py-20 sm:py-24 bg-surface/30 border-y border-line scroll-mt-20">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          {/* Portrait (left) — electric border signature */}
          {profile.photo && (
            <div className="lg:col-span-4">
              <Link to="/about" aria-label="Read the full about page" className="group block">
